...
public class RequestXml {
    ...
    protected List<RequestXml.Connector> connector;
     ...
     * {@link RequestXml.Connector }
     * 
     * 
     */
    public List<RequestXml.Connector> getConnector() {
        if (connector == null) {
            connector = new ArrayList<RequestXml.Connector>();
        }
    ...
    public static class Connector {
        ...
        @XmlElement(required = true)
        protected RequestXml.Connector.Data data;
         ...
         * @return
         *     possible object is
         *     {@link RequestXml.Connector.Data }
         *     
         */
        public RequestXml.Connector.Data getData() {
            return data;
        }
         ...
         *     
         */
        public void setData(RequestXml.Connector.Data value) {
            this.data = value;
        }
